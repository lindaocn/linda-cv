const translations = {
    en: {
        ...
        "hero-desc": "After my German Baccalaureate, my passion for the ocean and France led me to study in Bordeaux.",
        "edu-title": "Education",
    ...
    de: {
        ...
        "nav-contact": "Kontakt",
        "hero-title": "In den Bergen geboren,<br>am Ozean lebend.",
        "hero-desc": "Nach meinem Abitur führte mich meine Leidenschaft für den Ozean und Frankreich nach Bordeaux.",
    ...
    fr: {
        ...
        "hero-title": "Née dans les montagnes,<br>vivant à l'océan.",
        "hero-desc": "Après mon Baccalauréat allemand, ma passion pour l'océan et la France m'a amenée à étudier à Bordeaux.",
        "edu-title": "Formation",
        "edu-desc": "BUT Métiers du Multimédia et de l'Internet à l'IUT Bordeaux Montaigne",
        "lang-title": "Langues",
        "lang-desc": "Allemand langue maternelle<br>Anglais & Français courants<br>Débutant en Espagnol & Italien",
